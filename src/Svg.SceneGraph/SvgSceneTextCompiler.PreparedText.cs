...
internal static partial class SvgSceneTextCompiler
{
    ...
    private static string? GetNaturalTextAdvanceLanguage(SvgTextBase svgTextBase)
    {
        ...
        {
            if (TryGetNaturalTextLanguage(current, out var language))
            {
                return NormalizeNaturalTextAdvanceLanguage(language);
            }
        }
    ...
    private static bool TryGetNaturalTextLanguage(SvgElement element, out string language)
    {
